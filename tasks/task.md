...
# 任务1
- 我要创建一个以该网站作andrej-karpathy-skills为关键字网站，使用静态页面就行
-  项目的根路径就是当前目录.不要多一级了
- 使用cavas-design设计logo、favico


# 任务4
- 我的域名是andrej-karpathy-skills.lol 。利用webapp-launch-analytics这个处理下我的网站。利用seo相关的skill优化下。gsc、ga4、clariy中只接入gsc
## 重点
